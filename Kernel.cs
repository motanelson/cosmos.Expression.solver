...
namespace CosmosExpression
{
    ...
    class runexpression
    {
        ...
        public static Double total = 0.00; static Double value = 0.00; static string[] signal = { }; static Double[] parcel = { }; static int counter = 0; static Double d = 0.00; static String st;
